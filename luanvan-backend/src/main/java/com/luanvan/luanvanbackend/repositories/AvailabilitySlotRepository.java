...
public interface AvailabilitySlotRepository extends JpaRepository<AvailabilitySlot, Long> {
    ...
    @Query("SELECT s.slotId FROM AvailabilitySlot s " +
            "WHERE s.doctor.doctorId = :doctorId " +
            "AND s.specialty.specialtyId = :specialtyId " +
            "AND s.clinic.clinicId = :clinicId " +
            "AND s.date = :appointmentDate " +
            "AND s.startTime <= :appointmentTime " +
            "AND s.endTime > :appointmentTime")
    Long findSlotIdByDetails(@Param("doctorId") Long doctorId,
                             @Param("specialtyId") Long specialtyId,
